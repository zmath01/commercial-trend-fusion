...
<p class="sub"><b>This is link prediction over arXiv language, not a commercialization outcome.</b>
Hit = first co-occurrence in the test window with ≥3 joint papers.
...
<div class="callout warn"><b>Interpretation:</b> the committed test does not contain
independent patent, funding, hiring, company-formation, revenue, or market outcomes.
A successful link-prediction result would therefore not by itself establish
commercialization forecasting ability.</div>
<ul>
